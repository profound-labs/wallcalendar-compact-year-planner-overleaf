...
% https://github.com/profound-labs/wallcalendar-compact-year-planner-overleaf
%
...
\title{Wallcalendar in LaTeX, compact year planner layout}
...
%
% NOTE: This block seems to make the overleaf template time out for free tier accounts.
%
